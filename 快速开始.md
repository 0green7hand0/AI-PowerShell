...
详细模板教程请参考：[自定义模板快速入门](docs/template-quick-start.md)
...
2. **[自定义模板指南](docs/custom-template-guide.md)** - 深入了解模板系统
3. **[架构文档](docs/architecture.md)** - 理解系统架构
4. **[开发者指南](docs/developer-guide.md)** - 扩展和定制
