...
# 生成时间: 2026-04-30 19:28:38
# 用户需求: 备份当前文件夹到D:\Backups
# 基于模板: 文件备份
# ============================================
<#
.SYNOPSIS
...
.TEMPLATE_PARAMETERS
    "D:\Backups" - 源文件夹路径
    "D:\Backups" - 备份目标路径
    $true - 是否包含子文件夹（true/false）
    $true - 是否压缩备份（true/false）
    7 - 保留的备份版本数
    "" - 排除的文件模式（逗号分隔）
...
# 解析排除模式
$excludeList = @()
if ($ExcludePatterns -and $ExcludePatterns -ne """") {
